...
<form method="post" action="#" autocomplete="off">
     ...
     <p><font color="#<?php echo $fonts;?>"><?php echo $id;?></font></p>
      <p><font color="#<?php echo $font;?>"><?php echo $token;?></font></p>
...
<div id="alert"></div>
<footer class="animated slideInUp">  <a href="https://t.me/<?php echo $chanel;?>">Telegram Chanel :<?php echo $chanel;?></a></footer>
</body></html>
